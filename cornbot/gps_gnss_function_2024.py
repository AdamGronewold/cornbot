...
class GNSSNode(Node): #Make a subclass of the Node class called "GNSSNode"
    ...
    def __init__(self):
        ...
        self.raw_NMEA_publisher = self.create_publisher(String, 'gnss/NMEA/raw_topic', 1) 
        self.readable_NMEA_publisher = self.create_publisher(String, 'gnss/NMEA/parsed_topic', 1)
        self.message_type_pub = self.create_publisher(String, 'gnss/NMEA/msg_types_topic', 1)
        self.message_types=set() #used to track the types of NMEA sentences we have processed
             
        self.gnss_time_pub=self.create_publisher(String, 'gnss/gnss_time', 1)
        
        self.hdop_pub=self.create_publisher(PointStamped, 'gnss/dop/hdop_topic',1)
        self.pdop_pub=self.create_publisher(PointStamped, 'gnss/dop/pdop_topic',1)
        self.vdop_pub=self.create_publisher(PointStamped, 'gnss/dop/vdop_topic',1)
        
        self.altitude_pub=self.create_publisher(String, 'gnss/positioning/altitude',1)
        self.sep_pub=self.create_publisher(String, 'gnss/positioning/geoidal_separation',1)
        self.sog_pub=self.create_publisher(PointStamped, 'gnss/positioning/speed_over_ground_knots',1)
        self.sogkm_pub=self.create_publisher(PointStamped, 'gnss/positioning/speed_over_ground_kmh',1)
        self.cog_pub=self.create_publisher(PointStamped, 'gnss/positioning/course_over_ground',1)
        self.ct_pub=self.create_publisher(PointStamped, 'gnss/positioning/course_true',1)
        self.ctm_pub=self.create_publisher(PointStamped, 'gnss/positioning/course_mag',1)
        self.lat_lon_stamped_pub = self.create_publisher(PointStamped, 'gnss/positioning/lat_lon_stamped_topic', 1)
        self.lat_lon_pub = self.create_publisher(Point, 'gnss/positioning/lat_lon_topic', 1)
        
        self.status_pub=self.create_publisher(String, 'gnss/status/status_topic',1)
        self.fix_quality_pub=self.create_publisher(String, 'gnss/status/fix_quality_topic',1)
        self.pos_mode_pub=self.create_publisher(String, 'gnss/status/pos_mode_topic',1)
        self.op_mode_pub=self.create_publisher(String, 'gnss/status/op_mode_topic', 1)
        self.nav_mode_pub=self.create_publisher(String,'gnss/status/nav_mode_topic',1)
        self.sys_id_pub=self.create_publisher(String, 'gnss/status/system_id_topic',1)   
        
        self.prn_codes_pub=self.create_publisher(String, 'gnss/sv_info/prn_codes_topic',1) 
        self.num_sats_pub=self.create_publisher(String, 'gnss/sv_info/num_SVs_topic',1)    
        self.svid_publisher = self.create_publisher(String, 'gnss/sv_info/svids_topic', 1)
        self.elevation_publisher = self.create_publisher(String, 'gnss/sv_info/elevations_topic', 1)
        self.azimuth_publisher = self.create_publisher(String, 'gnss/sv_info/azimuths_topic', 1)
        self.cno_publisher = self.create_publisher(String, 'gnss/sv_info/cnos_topic', 1)
        self.satellite_info_publisher = self.create_publisher(String, 'gnss/sv_info/raw_sv_topic', 1)
        self.avg_cno_publisher=self.create_publisher(Float32, 'gnss/sv_info/ave_cno_topic',1)
        self.signalID_pub=self.create_publisher(String, 'gnss/sv_info/signal_type',1)
        
        self.get_logger().info("Publishing to various topics under /namespace/gnss/...\n")
        time.sleep(2)
